...
import { admissionsCta, programBrand, programImages } from "../data/perfectManContent";
        ...
        <div className="inquiry-grid">
          <div className="section-content">
            ...
            <ul>
              ...
              <li>
                <CheckCircle2 size={16} /> Guidance on choosing the right program format
              </li>
              <li>
                <CheckCircle2 size={16} /> Small batches — limited seats per program
              </li>
            </ul>
            <p className="section-copy">
              Prefer to talk right away? Call us at{" "}
              <a className="inline-link" href={admissionsCta.phoneHref}>{admissionsCta.phone}</a>.
            </p>
          </div>
          <InquiryForm />
        </div>
      ...
      <section className="admissions-section">
        <div className="admissions-card">
          ...
          <div className="hero-actions">
            ...
            <Link to="/contact" className="outline-btn">Book a Child Assessment</Link>
          </div>
          <div className="admissions-contact">
            <p><Phone size={14} /> {admissionsCta.phone}</p>
            <p>
              <Mail size={14} />{" "}
            ...
            <p><MapPin size={14} /> {admissionsCta.address}</p>
          </div>
        </div>
      </section>
    </main>
